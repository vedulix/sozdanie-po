...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{../../reports/screenshots/SCR-20260328-qdfe.png}
\hfill
\includegraphics[width=0.45\textwidth]{../../reports/screenshots/SCR-20260328-qdgn.png}
\caption{Диалоги: стандартные (слева) и немодальный поиск (справа)}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{../../reports/screenshots/SCR-20260328-qdef.png}
\hfill
\includegraphics[width=0.45\textwidth]{../../reports/screenshots/SCR-20260328-qder.png}
\caption{График синусоиды (слева) и столбчатая диаграмма (справа)}
\end{figure}
